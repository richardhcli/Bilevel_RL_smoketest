...
def main():
    ...
    csv_path = (
        ...
        / "Value_lambda_0.1_fix1_maxfeed100_Rbatch10_seed12345"
        / "eval.csv"
    )
    ...
    parts = [
        ...
        '<text x="360" y="26" text-anchor="middle" font-size="22" font-family="Arial">Walker OURS Eval Episode Reward</text>',
    ]
    ...
    parts.extend([
        ...
        f'<polyline fill="none" stroke="#d62728" stroke-width="2.5" points="{points}" />',
    ])
    ...
    out_path = ROOT / "figs" / "walker_ours_eval.svg"
