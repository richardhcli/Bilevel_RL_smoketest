...
def main():
    ...
    series = {
        "PEBBLE": load_eval_points(base / "PEBBLE_walker_refresh_maxfeed100_Rbatch10_seed12345" / "eval.csv"),
        "OURS": load_eval_points(base / "Value_lambda_0.1_fix1_maxfeed100_Rbatch10_seed12345" / "eval.csv"),
    }
    ...
    parts = [
        ...
        '<text x="380" y="28" text-anchor="middle" font-size="22" font-family="Arial">Walker Eval Episode Reward: PEBBLE vs OURS</text>',
    ]
    ...
    out_path = ROOT / "figs" / "walker_eval_pebble_vs_ours.svg"
